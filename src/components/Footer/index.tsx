...
function Footer() {
  return (
    <footer
      className="relative h-[308px] pt-[116px] mt-[calc(140px-28px)] max-lg:h-[428px] max-lg:pt-[92px]"
      role="contentinfo"
    >
      <div className="absolute inset-0 z-0 bg-primary-teal" aria-hidden="true">
        <Image
      ...
      <div
        className="absolute left-1/2 top-[calc(-140px+28px)] transform -translate-x-1/2"
        aria-hidden="true"
      >
